...
class ResNetAttentionVisual(nn.Module):
    ...
    def __init__(self, device, num_class, num_layers, dim, hidden_dim,
        ...
        self.layers = nn.ModuleList()
        self.feature_extract = ResNet(BasicBlock, [2, 2, 2, 2], num_classes = num_class, nseq = max_length, out_dim=128)
        self.positional_encoding_feature = PositionalEmbedding(dim=128, max_length=max_length)
    ...
    def forward(self, x):        
        ...
        x = self.positional_encoding_feature(x)
